...
publication: In *International Conference on Pattern Recognition (ICPR 2026)*
publication_short: In *ICPR 2026*
abstract: |
...
summary: A simple prefilling strategy that makes first-token probability evaluation more reliable for multiple-choice LLM benchmarks.
